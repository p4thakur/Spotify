  ...
  return (
    <div className="footer">
      ...
      <div className="footer_center">
        ...
        <SkipPreviosIcon className="footer_icon" />
        <PlayCircleOutlineIcon fontSize="large" className="footer_icon" />
        <SkipPreviosIcon className="footer_icon" />
        <ReapeatIcon className="footer_green" />
      </div>
